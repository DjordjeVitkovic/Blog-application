        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Sizes Form</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form:form action="slide-save" modelAttribute="slide" role="form">
              <form:hidden path="id"/>
                <div class="card-body">
                  <div class="form-group">
                    <label>Title</label>
                    <form:input path="title" type="text" class="form-control" placeholder="Enter name"/>
                  </div>
              
                  <div class="form-group">
                    <label>Image</label>
                    <form:input path="image" type="text" class="form-control" placeholder="Enter name"/>
                  </div>
                
                  <div class="form-group">
                    <label>Link name</label>
                    <form:input path="linkName" type="text" class="form-control" placeholder="Enter name"/>
                  </div>
              
                  <div class="form-group">
                    <label>Link</label>
                    <form:input path="linkPath" type="text" class="form-control" placeholder="Enter name"/>
                  </div>
              
              	<div class="form-group">
                    <label>Position</label>
                    <form:input path="position" type="text" class="form-control" placeholder="Enter name"/>
                  </div>
                  
                <div class="form-check">
                    <form:checkbox path="isVisible" class="form-check-input" id="exampleCheck1"/>
