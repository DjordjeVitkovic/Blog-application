            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <a href="slide-form" class="btn btn-success">
                ...
                <table class="table table-bordered">
                  ...
                  <c:forEach var="slide" items="${slideList}">
                    <tr>                             
                      ...
                      <td class="text-center"><img src="${slide.image}"
						style="max-width: 80px;"></td>
                      <td class="text-center">${slide.position}</td>
                      <td class="text-center">
                        <div class="btn-group">
                        	<a href="slide-visible?id=${slide.id}"
							class="btn btn-info"> 
							<c:if test="${slide.isVisible}">
							<i class="fas fa-eye"></i>
							</c:if>
							<c:if test="${!slide.isVisible}">
							<i class="fas fa-eye-slash" style="color:#ffd31a;"></i>
							</c:if>
							</a> 
                        
                          <a href="slide-form-update?id=${slide.id}" class="btn btn-info">
                            <i class="fas fa-edit"></i>
                          </a>
                          <button type="button" class="btn btn-info" data-toggle="modal" data-target="#delete-modal-${slide.id}">
                            <i class="fas fa-trash"></i>
                          </button>
                        </div>
                      </td>
                    </tr>    
	<div class="modal fade" id="delete-modal-${slide.id}">
     <div class="modal-dialog">
       <div class="modal-content">
         ...
         <div class="modal-footer justify-content-between">
           ...
           <a href="slide-delete?id=${slide.id}"
