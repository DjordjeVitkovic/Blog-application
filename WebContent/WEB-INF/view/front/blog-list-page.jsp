        ...
        <main class="posts-listing col-lg-8"> 
          <div class="container">
              ...
              <div class="post col-xl-6">
                ...
                <div class="post-details">
                  <div class="post-meta d-flex justify-content-between">
                    ...
                    <c:if test="${blog.category != null}">
                    <div class="category"><a href="blog-list-category?id=${blog.category.id}&page=1">${blog.category.name}</a></div>
                    </c:if>
                  </div><a href="blog-post?id=${blog.id}">
                    <h3 class="h4">${blog.title}</h3></a>
                  <p class="text-muted">${blog.description}</p>
                  <footer class="post-footer d-flex align-items-center"><a href="blog-list-author?username=${blog.user.username}&page=0" class="author d-flex align-items-center flex-wrap">
            ...
            <nav aria-label="Page navigation example">
              ...
              <c:if test="${page>0}">
                <li class="page-item"><a href="blog-list-page-change?page=${page}&type=left" class="page-link"> <i class="fa fa-angle-left"></i></a></li>
                </c:if>
                
                <c:forEach var="i" begin="0" end="${size/12}">
                <c:if test="${page == i}">
                <li class="page-item"><a href="blog-list-page?page=${i}" class="page-link active">${i+1}</a></li>
                </c:if>
                <c:if test="${page != i}">
                <li class="page-item"><a href="blog-list-page?page=${i}" class="page-link">${i+1}</a></li>
                </c:if>
                </c:forEach>
                  
                <c:if test="${page<size/12-1}">
                <li class="page-item"><a href="blog-list-page-change?page=${page}&type=right" class="page-link"> <i class="fa fa-angle-right"></i></a></li>
                </c:if>
              </ul>
            </nav>
          </div>
