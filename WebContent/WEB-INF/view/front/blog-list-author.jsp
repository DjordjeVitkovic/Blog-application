        ...
        <main class="posts-listing col-lg-8"> 
          ...
          <h2 class="mb-3 author d-flex align-items-center flex-wrap">
              <div class="avatar"><img src="${user.image}" alt="..." class="img-fluid rounded-circle"></div>
                <div class="title">
                <span>Posts by author "${user.name} ${user.surname}"</span>
              </div>
            </h2>
            <div class="row">
              <!-- post -->
            ...
            <nav aria-label="Page navigation example">
              ...
              <c:if test="${page>0}">
                <li class="page-item"><a href="blog-list-page-change?username=${user.username}&page=${page}&type=left" class="page-link"> <i class="fa fa-angle-left"></i></a></li>
                </c:if>
                ...
                <li class="page-item"><a href="blog-list-page-change?username=${user.username}&page=${page}&type=right" class="page-link"> <i class="fa fa-angle-right"></i></a></li>
                </c:if>
              </ul>
            </nav>
          </div>
