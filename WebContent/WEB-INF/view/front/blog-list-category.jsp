          ...
          <div class="container">
           <h2 class="mb-3">"${category.name}"</h2>
            ...
            <nav aria-label="Page navigation example">
              ...
              <c:if test="${page>0}">
                <li class="page-item"><a href="blog-list-category-change?id=${category.id}&page=${page}&type=left" class="page-link"> <i class="fa fa-angle-left"></i></a></li>
                </c:if>
                
                <c:forEach var="i" begin="0" end="${size/12}">
                <c:if test="${page == i}">
                <li class="page-item"><a href="blog-list-category?id=${category.id}&page=${i}" class="page-link active">${i+1}</a></li>
                </c:if>
                <c:if test="${page != i}">
                <li class="page-item"><a href="blog-list-category?id=${category.id}&page=${i}" class="page-link">${i+1}</a></li>
                </c:if>
                </c:forEach>
                  
                <c:if test="${page<size/12-1}">
                <li class="page-item"><a href="blog-list-category-change?id=${category.id}&page=${page}&type=right" class="page-link"> <i class="fa fa-angle-right"></i></a></li>
                </c:if>
              </ul>
            </nav>
          </div>
