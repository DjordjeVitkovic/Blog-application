...
<html>
  <head>
    ...
    <title>Blogs about ${tag.name}</title>
        ...
        <div class="container">
          ...
          <div id="navbarcollapse" class="collapse navbar-collapse">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item"><a href="blog-list-page?page=1" class="nav-link active">Blog</a>
              </li>
        ...
        <main class="posts-listing col-lg-8"> 
          <div class="container">
           <h2 class="mb-3">"${tag.name}"</h2>
          	<p class="text-muted">Showed ${blogList.size()} of ${numberOfBlogs}</p> 
            ...
            <nav aria-label="Page navigation example">
              ...
              <c:if test="${page>0}">
                <li class="page-item"><a href="blog-list-tag-change?id=${tag.id}&page=${page}&type=left" class="page-link"> <i class="fa fa-angle-left"></i></a></li>
                </c:if>
                <c:if test="${page == 0}">
                <li class="page-item"><a href="blog-list-tag?id=${tag.id}&page=0" class="page-link active">1</a></li>
                </c:if>
                <c:if test="${page != 0}">
                <li class="page-item"><a href="blog-list-tag?id=${tag.id}&page=0" class="page-link">1</a></li>
                </c:if>
              <c:if test="${size > 1}">
                <c:if test="${page == 1}">
                <li class="page-item"><a href="blog-list-tag?id=${tag.id}&page=1" class="page-link active">2</a></li>
                </c:if>
                <c:if test="${page != 1}">
                <li class="page-item"><a href="blog-list-tag?id=${tag.id}&page=1" class="page-link">2</a></li>
                </c:if>
               </c:if>
               <c:if test="${size > 2}">
                <c:if test="${page == 2}">
                <li class="page-item"><a href="blog-list-tag?id=${tag.id}&page=2" class="page-link active">3</a></li>
                </c:if>
                <c:if test="${page != 2}">
                <li class="page-item"><a href="blog-list-tag?id=${tag.id}&page=2" class="page-link">3</a></li>
                </c:if>               
                </c:if>
                
                <c:if test="${page<size && size > 3}">
                <li class="page-item"><a href="blog-list-tag-change?id=${tag.id}&page=${page}&type=right"" class="page-link"> <i class="fa fa-angle-right"></i></a></li>
                </c:if>
              </ul>
            </nav>
