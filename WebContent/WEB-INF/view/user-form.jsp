								...
								<form:form role="form" action="user-save" modelAttribute="user">
									...
									<div class="card-body">
										...
										<div class="form-group">
											<label>Role</label> 
											<div>
											<form:checkboxes  path="authorities" items="${roles}" itemLabel="authority" itemValue="authority" element="div class='form-check form-check-inline'" class="form-check-input" id="size-checkbox-1"
												/>
												</div>
												<form:errors path="image" cssClass="text-danger"/>
										</div>
